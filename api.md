...
Note that Ninchat web client prefixes `id`, `name` and each `class` with "nui-ext-". Eg. if "button ok" `class` string is set, it will be rendered as class="nui-ext-button nui-ext-ok" in Ninchat web client.
